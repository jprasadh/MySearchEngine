...
def sort_results(pages, ranks):
    ...
    for page in pages:
        if ranks[page] < ranks[pivot]:
            lower_set.append(page)
        elif ranks[page] > ranks[pivot]:
            upper_set.append(page)
    output = sort_results(upper_set, ranks) + [pivot] + sort_results(lower_set, ranks)
    return output
...
def ordered_search(index, ranks, keyword):
    ...
    if not pages:
        ...
        return sort_results(pages, ranks)
...
pages = lookup(index, 'Hummus')
print(sort_results(pages, ranks))
