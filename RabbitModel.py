...
# Before dying, the rabbits(n) = rabbits(n - 1) + rabbits(n - 2) - rabbits(n - 5)bunnies reproduce.
#
#
...
def rabbits(n):
    ...
    if n < 6:
        ...
        next_rabbits = 1
        for i in range(0, n):
            current_rabbits, next_rabbits = next_rabbits, current_rabbits + next_rabbits
    else:
        current_rabbits = rabbits(n - 1) + rabbits(n - 2) - rabbits(n - 5)
